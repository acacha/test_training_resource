...
(function () {
    ...
    app.config(function (NgAdminConfigurationProvider, RestangularProvider) {
        ...
        var admin = nga.application('ng-admin backend demo') // application main title
            .baseApiUrl('http://trainingresource.app/api/'); // main API endpoint

        // define all entities at the top to allow references between them
        var post = nga.entity('training_resource'); // the API endpoint for posts will be http://localhost:3000/posts/:id
